package com.raspberry.library.multiselect;
...
import com.raspberry.library.multiselect.adapter.FolderAdapter;
import com.raspberry.library.multiselect.adapter.ImageGridAdapter;
import com.raspberry.library.multiselect.bean.Folder;
import com.raspberry.library.multiselect.bean.Image;
import com.raspberry.library.multiselect.utils.FileUtils;
import com.raspberry.library.multiselect.utils.ScreenUtils;
...
public class MultiImageSelectorFragment extends Fragment {
    ...
    private void showCameraAction() {
        if (ContextCompat.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE) !=
            ...
            requestPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE, getString(R.string
                    .mis_permission_rationale_write_storage), REQUEST_STORAGE_WRITE_ACCESS_PERMISSION);
        } else {
    ...
    private void requestPermission(final String permission, String rationale, final int requestCode) {
        if (shouldShowRequestPermissionRationale(permission)) {
            new AlertDialog.Builder(getContext()).setTitle(R.string.mis_permission_dialog_title).setMessage
                    (rationale).setPositiveButton(R.string.mis_permission_dialog_ok, new DialogInterface
                    .OnClickListener() {
                @Override
    ...
    private LoaderManager.LoaderCallbacks<Cursor> mLoaderCallback = new LoaderManager.LoaderCallbacks<Cursor>() {
        ...
        private final String[] IMAGE_PROJECTION = {MediaStore.Images.Media.DATA, MediaStore.Images.Media
                .DISPLAY_NAME, MediaStore.Images.Media.DATE_ADDED, MediaStore.Images.Media.MIME_TYPE, MediaStore
                .Images.Media.SIZE, MediaStore.Images.Media._ID};
        ...
        public Loader<Cursor> onCreateLoader(int id, Bundle args) {
            ...
            if (id == LOADER_ALL) {
                cursorLoader = new CursorLoader(getActivity(), MediaStore.Images.Media.EXTERNAL_CONTENT_URI,
                        ...
                        IMAGE_PROJECTION[3] + "=? ", new String[]{"image/jpeg", "image/png"}, IMAGE_PROJECTION[2] + "" +
                        " DESC");
            } else if (id == LOADER_CATEGORY) {
                cursorLoader = new CursorLoader(getActivity(), MediaStore.Images.Media.EXTERNAL_CONTENT_URI,
                        IMAGE_PROJECTION, IMAGE_PROJECTION[4] + ">0 AND " + IMAGE_PROJECTION[0] + " like '%" + args
