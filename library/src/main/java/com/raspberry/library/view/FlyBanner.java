...
/**
 * Created by xiaohu on 2016/11/26.
 */
...
public class FlyBanner extends RelativeLayout {
    ...
    //指示点资源
    private int mPointDrawableResId = R.drawable.dot_selector;
    //指示容器背景
     ...
     * @param id
     */
    public void setPointDrawableResId(int id) {
        if (id > 0)
            mPointDrawableResId = id;
    }
    ...
    private class FlyPageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (mIsImageUrl) {
                ...
                Glide.with(getContext()).load(mImages.get(toRealPosition(position))).into(imageView);
            }
    ...
    private void addPoints() {
        ...
        int size = DisplayUtils.dip2px(getContext(), 8);
    ...
    private void switchToPoint(final int currentPoint) {
        ...
        mPointRealContainerLl.getChildAt(currentPoint).setSelected(true);
    }
    ...
    private FlyBanner.OnItemClickListener mOnItemClickListener;

    public void setOnItemClickListener(FlyBanner.OnItemClickListener listener) {
