...
public class DialogMaker {
    ...
    public static EasyProgressDialog showProgressDialog(Context context, String title, String message, boolean
            canCancelable, OnCancelListener listener) {
        ...
        if (progressDialog == null) {
            ...
            Logger.e("dialog %s", "there is a leaked window here,orign context: " + progressDialog.getContext() + " " +
                    "now: " + context);
