...
public class ToastUtils {
     ...
     * @param gravity
     */
    public static void showToast2(String msg, int gravity) {
        showToast(msg, DEFAULT_TIME, gravity, DEFAULT_XOFFSET, DEFAULT_YOFFSET);
    }
     ...
     * @param yOffset
     */
    public static void showToast(final String msg, final int duration, final int gravity, final int xOffset, final
    int yOffset) {
