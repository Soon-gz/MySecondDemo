...
public class MessageFragment extends TFragment implements ModuleProxy {
    ...
    protected P2PMessageActivity.Status status;
    ...
    private void parseIntent() {
        ...
        status = (P2PMessageActivity.Status) getArguments().getSerializable(Extras.EXTRA_STATUS);
        ...
        if (inputPanel == null) {
            ...
            inputPanel.getOrderBtn().setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent("com.shkjs.patient.order_picture");
                    intent.putExtra("doctorName", sessionId);
        ...
        if (null != status && status.equals(P2PMessageActivity.Status.COMPLETE)) {
            inputPanel.getMessageActivityBottomLayout().setVisibility(View.GONE);
            inputPanel.getOrderBtn().setVisibility(View.VISIBLE);
        } else {
            inputPanel.getMessageActivityBottomLayout().setVisibility(View.VISIBLE);
            inputPanel.getOrderBtn().setVisibility(View.GONE);
        }
