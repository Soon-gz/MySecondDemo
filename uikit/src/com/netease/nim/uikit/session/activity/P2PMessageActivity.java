...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    public static void start(Context context, String contactId, SessionCustomization customization, IMMessage anchor,
        ...
        if (status != null) {
            intent.putExtra(Extras.EXTRA_STATUS, status);
        }
        intent.setClass(context, P2PMessageActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
    ...
    private void requestBuddyInfo() {
        if (getIntent().getStringExtra(Extras.EXTRA_NAME) != null) {
            setTitle(getIntent().getStringExtra(Extras.EXTRA_NAME));
        } else {
    ...
    protected void initToolBar() {
        titleTV = findView(R.id.toolbar_title);
...
//            //            getToolBar().setPadding(getToolBar().getPaddingLeft(), ScreenUtil.getStatusBarHeight(this),
//            // getToolBar()
//            //                    .getPaddingRight(), getToolBar().getPaddingBottom());
//        }
    }
